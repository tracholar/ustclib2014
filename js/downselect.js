...
function bottomForm(search_form) {
    if (search_form.catid.value == 4) {
        search_form.action = "" + encodeURI(search_form.infos.value) + "&modelid=4";
        document.search_form.submit();
        return false;
    } else if (search_form.catid.value == 5) {
        search_form.action = "" + encodeURI(search_form.infos.value) + "&modelid=5";
        document.search_form.submit();
        return false;
    } else {
        search_form.action = "" + encodeURI(search_form.infos.value) + "&modelid=" + search_form.catid.value;
        document.search_form.submit();
        return false;
    }
}